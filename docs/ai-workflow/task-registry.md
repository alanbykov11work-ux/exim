...
| `TASK-2026-002` | Self-hosted PostgreSQL preview | `submitted` | `product-os-task-2026-001-r1` (scope reference) | `ea049dca75e3a2e0f1e936156ab8c7fc80091e7a` | `SUB-TASK-2026-002-01`, PR [#6](https://github.com/alanbykov11work-ux/exim/pull/6), app `3a94d00` | Независимый review; затем отдельное human acceptance решение |
