...
| `TASK-2026-002` | Self-hosted PostgreSQL preview | `in_progress` | `product-os-task-2026-001-r1` (scope reference) | `ea049dca75e3a2e0f1e936156ab8c7fc80091e7a` | — | Isolated deploy, database/backup/restore and tenant/auth E2E |
